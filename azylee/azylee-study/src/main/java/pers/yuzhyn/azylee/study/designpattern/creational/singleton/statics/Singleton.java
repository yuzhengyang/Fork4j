package pers.yuzhyn.azylee.study.designpattern.creational.singleton.statics;
 ...
 * 它跟第 3饿汉式 种方式不同的是：
 * 第 3饿汉式 种方式只要 Singleton 类被装载了，那么 instance 就会被实例化（没有达到 lazy loading 效果），
 ...
 * 那么这个时候实例化 instance 显然是不合适的。这个时候，这种方式相比第 3饿汉式 种方式就显得很合理。
 */
