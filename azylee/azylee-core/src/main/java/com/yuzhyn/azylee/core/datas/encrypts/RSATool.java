...
public class RSATool {
    ...
    public static void main(String[] args) throws Exception {
        Map<String, String> keyMap = RSATool.createKeys(1024);
        ...
        String encodedData = RSATool.publicEncrypt(str, RSATool.getPublicKey(publicKey));  //传入明文和公钥加密,得到密文
        System.out.println("密文：\r\n" + encodedData);
        String decodedData = RSATool.privateDecrypt(encodedData, RSATool.getPrivateKey(privateKey)); //传入密文和私钥,得到明文
